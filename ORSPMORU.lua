...
function vice:Window(textgame)
	...
	function Tabs:Tab(text)
		...
		Tab.BackgroundColor3 = Color3.fromRGB(148, 96, 194)
		...
		function ContainerItems:Button(text, callback)
			...
			Button.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
		...
		function ContainerItems:Toggle(text, callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
		...
		function ContainerItems:Slider(text, min, max, start, callback) 
			...
			Slider.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
			...
			SliderFrame.BackgroundColor3 = Color3.fromRGB(32, 2, 57)
		...
		function ContainerItems:Dropdown(text, list, callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
			...
			DropdownFrame.BackgroundColor3 = Color3.fromRGB(55, 8, 83)
			...
			for i, v in next, list do
				...
				Item.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
		...
		function ContainerItems:Colorpicker(text, preset, callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
		...
		function ContainerItems:Label(text)
			...
			Label.BackgroundColor3 = Color3.fromRGB(53, 4, 84)
		...
		function ContainerItems:Textbox(text, disapper, callback)
			...
			Textbox.BackgroundColor3 = Color3.fromRGB(62, 28, 103)
