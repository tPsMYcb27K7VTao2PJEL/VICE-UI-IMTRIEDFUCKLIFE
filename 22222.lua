...
local CircleCorner_3 = Instance.new("UICorner")
...
function vice:Window(textgame)
	...
	MainFrame.BackgroundColor3 = Color3.fromRGB(34, 34, 45)
	...
	LeftFrame.BackgroundColor3 = Color3.fromRGB(14, 14, 30)
	...
	coroutine.wrap(
		function()
			while wait() do
				RainbowLine.BackgroundColor3 = Color3.fromRGB(15, 15, 32)
	...
	function Tabs:Tab(text)
		...
		coroutine.wrap(
			function()
				while wait() do
					Tab.BackgroundColor3 = Color3.fromRGB(25, 25, 41)
				end
			end
		)()
		...
		function ContainerItems:Toggle(text, callback)
			...
			Toggle.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
			...
			ToggleFrameRainbow = Color3.fromRGB(255, 0, 0)
		...
		function ContainerItems:Slider(text, min, max, start, callback) 
			...
			Slider.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
		...
		function ContainerItems:Dropdown(text, list, callback)
			...
			Dropdown.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
			...
			DropdownFrame.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
			...
			for i, v in next, list do
				...
				Item.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
		...
		function ContainerItems:Colorpicker(text, preset, callback)
			...
			Colorpicker.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
			...
			ColorpickerFrame.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
			...
			Confirm.BackgroundColor3 = Color3.fromRGB(43, 43, 60)
...
CircleCorner_3.Name = "CircleCorner"
CircleCorner_3.Parent = PlayerImage

PlayerName.Name = "PlayerName"
PlayerName.Parent = Frame
PlayerName.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
PlayerName.BackgroundTransparency = 1.010
PlayerName.Position = UDim2.new(0.301572341, 0, 0.145454511, 0)
PlayerName.Size = UDim2.new(0, 97, 0, 60)
PlayerName.Font = Enum.Font.Gotham
PlayerName.Text = ""
PlayerName.TextColor3 = Color3.fromRGB(255, 255, 255)
PlayerName.TextSize = 13.000

statusnm.Name = "statusnm"
statusnm.Parent = Frame
statusnm.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
statusnm.BackgroundTransparency = 1.010
...
coroutine.wrap(IDAAYFE_fake_script)()
local function WAULAMB_fake_script() -- Frame.Image 
